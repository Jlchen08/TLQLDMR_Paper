...
\begin{table}[ht]
\centering
\caption{Deterministic point prediction results on the extreme weather test set of Farm~6 . Best results are highlighted in bold (similarly hereinafter).}
...
\begin{table}[ht]
\centering
\caption{Model performance ($R^2$) under varying SNR on the Farm~6 extreme weather test set.}
\setlength{\tabcolsep}{3.5mm}
...
\begin{table*}[ht]
\centering
\caption{Interval prediction results on the extreme weather test set of Farm~6 at 95\% confidence level ($\alpha = 0.05$).}
\setlength{\tabcolsep}{4mm}
\begin{tabular}{lccccc}
\toprule
...
To examine robustness under measurement perturbation, additional Gaussian noise is injected into the test inputs at SNR levels of 30, 40, and 60\,dB.
...
\begin{table*}[ht]
\centering
\caption{Interval prediction results under varying SNR on the extreme weather test set of Farm~6 at 95\% confidence level ($\alpha = 0.05$).}
...
\begin{table*}[ht]
\centering
\caption{Ablation study evaluations for point and interval c prediction on the Farm 6 test set.}
\setlength{\tabcolsep}{3mm}
