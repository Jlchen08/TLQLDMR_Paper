...
\textbf{Interval forecasting achieves a better reliability-sharpness balance.} In Experiment~3, TLQLDMR is the only method that simultaneously maintains target-level coverage and the best composite penalty (CWC), and this advantage persists under injected measurement noise.
